      ...
      <div className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
        <div className="p-4 md:p-12 text-center lg:text-left">
          <div
            ...
            style={{ backgroundImage: "url(" + DeepakImage + ")" }}
          ></div>
          ...
          <p className="pt-8 text-sm">
            ...
            <br />
            <span className="text-bold">Work At </span>
            <button
              type="button"
          ...
          <div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
            <a
              className="link"
              href="https://facebook.com/deepakkhadka.me"
            ...
            <a
              className="link"
              href="https://twitter.com/deepak_khadka15"
            ...
            <a
              className="link"
              href="https://github.com/Deepak-khadka"
            ...
            <a
              className="link"
              href="https://dribbble.com/deepak_khadka159"
            ...
            <a
              className="link"
              href="https://www.instagram.com/dpk_khadka/"
