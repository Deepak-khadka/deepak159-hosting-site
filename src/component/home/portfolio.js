          ...
          <div
              ...
              <div className="p-4 md:p-12 text-center lg:text-left">
                  ...
                  <div
                      ...
                      <a className="link" href="https://facebook.com/deepakkhadka.me" data-tippy-content="@facebook_handle">
                      ...
                      <a className="link" href="https://twitter.com/deepak_khadka15" data-tippy-content="@twitter_handle">
                          <svg className="h-6 fill-current text-gray-600 hover:text-green-700" role="img"
                      ...
                      <a className="link" href="https://github.com/Deepak-khadka" data-tippy-content="@github_handle">
                          <svg className="h-6 fill-current text-gray-600 hover:text-green-700" role="img"
                      ...
                      <a  className="link" href="https://dribbble.com/deepak_khadka159" data-tippy-content="@dribble_handle">
                          <svg className="h-6 fill-current text-gray-600 hover:text-green-700" role="img"
                      ...
                      <a  className="link" href="https://www.instagram.com/dpk_khadka/" data-tippy-content="@instagram_handle">
                          <svg className="h-6 fill-current text-gray-600 hover:text-green-700" role="img"
